...
class MenageAdmin(admin.ModelAdmin):
    list_display = ('identite', 'village_quartier', 'numero_menage', 'date_enquete', 'nom_enqueteur', 'score_total', 'niveau_vulnerabilite')
    search_fields = ('identite', 'village_quartier', 'numero_menage', 'nom_enqueteur')
    list_filter = ('village_quartier', 'nom_enqueteur', 'niveau_vulnerabilite', 'date_enquete')
